...
function GridContentRow({ file }: { file: MdxListItem }) {
  return (
...
function CardTitle({ file }: { file: MdxListItem }) {
  return (
...
function CardContentRow({ file }: { file: MdxListItem }) {
  return (
...
function rfdTable({ rfds }: { rfds: MdxListItem[] }): React.ReactElement {
  const count = rfds.length.toString();
  return (
    <div {...stylex.props(styles.main)}>
      <h1 {...stylex.props(styles.title, styles.text)}>
